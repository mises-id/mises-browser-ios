...
void OSExchangeDataProviderAndroid::SetString(const std::u16string& data) {
  if (HasString())
    return;
...
bool OSExchangeDataProviderAndroid::GetString(std::u16string* data) const {
...
bool OSExchangeDataProviderAndroid::GetFileContents(
...
bool OSExchangeDataProviderAndroid::HasFileContents() const {
  return !file_contents_filename_.empty();
}

void OSExchangeDataProviderAndroid::SetHtml(const std::u16string& html,
                                              const GURL& base_url) {
...
bool OSExchangeDataProviderAndroid::GetHtml(std::u16string* html,
                                              GURL* base_url) const {
...
void OSExchangeDataProviderAndroid::CopyData(
    OSExchangeDataProviderAndroid* provider) const {
  DCHECK(provider);
