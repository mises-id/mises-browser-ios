...
#ifndef UI_BASE_DRAGDROP_OS_EXCHANGE_DATA_PROVIDER_ANDROID_BACKED_H_
#define UI_BASE_DRAGDROP_OS_EXCHANGE_DATA_PROVIDER_ANDROID_BACKED_H_
...
class COMPONENT_EXPORT(UI_BASE) OSExchangeDataProviderAndroid
 ...
 protected:
  ...
  void CopyData(OSExchangeDataProviderAndroid* provider) const;
...
#endif  // UI_BASE_DRAGDROP_OS_EXCHANGE_DATA_PROVIDER_ANDROID_BACKED_H_
